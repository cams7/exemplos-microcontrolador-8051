...
inicio:
        ...
        mov     TH1,#0FAh       ;Timer1 configurado para gerar baud rate de 9600
                                ...
                                ;Outros calculos:
                                ;Cristal: 12MHz, Baud Rate: 9600, SMOD:1  
                                ;12e6/12*(1/(9600/(2^1/32))) = 6,5104...  
                                
                                ;Cristal: 11,059MHz, Baud Rate: 9600, SMOD:0                           
                                ;11059000/12*(1/(9600/(2^0/32))) = 2,9999457... = 3
                                ;2^8-3 = 253 = FD
                                
                                ;Cristal: 11,059MHz, Baud Rate: 57600, SMOD:1 
                                ;11059000/12*(1/(57600/(2^1/32))) = 0,99998... = 1
                                ;2^8-1 = 255 = FF

                                ;Cristal: 11,059MHz, Baud Rate: 57600, SMOD:0
                                ;11059000/12*(1/(57600/(2^0/32))) = 0,4999909...                       
