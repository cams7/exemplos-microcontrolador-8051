...
; --- Vetor de RESET ---
        ...
        ajmp    init            ;desvia das rotinas de interrupção


; --- Vetor de Interrupção ---

; -- Vetor de Interrupção do TL0 (Modo 3) --
...
; -- Vetor de Interrupção do TH0 (Modo 3) --
...
main:
        mov     IE,#82h         ;habilita apenas interrupção do Timer0
                                ;Registrador IE (Interrupt Enable) - Habilita Interrupção
                                ;EA .. ES ET1 EX1 ET0 EX0
                                ;1  00 0  0   0   1   0                             
                                
        clr     FREQ2           ;limpa saída da frequência 2
        acall   delay500ms      ;chama sub rotina para aguardar 500 ms

        mov     IE,#88h         ;habilita apenas interrupção do Timer1
                                ;Registrador IE (Interrupt Enable) - Habilita Interrupção
                                ;EA .. ES ET1 EX1 ET0 EX0
                                ;1  00 0  1   0   0   0

        clr     FREQ1           ;limpa saída da frequência 1
